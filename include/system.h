...
#define lk_memnxt    $fd00    ;// 256 bytes - 1 byte for each internal page
#define lk_memown    $fe00    ;// 256 bytes - 1 byte for each internal page
...
#define lk_timedive  $ff02    ;// exponent of time dic
#define lk_timedivm  $ff03    ;// mantisse of timediv

;lk_tstatus   $ff05 - $ff24
;lk_tnextt    $ff25 - $ff44
;lk_tslice    $ff45 - $ff64
;lk_ttsp      $ff65 - $ff84
;lk_memmap    $ff85 - $ffa4
;lk_smbmap    $ffa5 - $ffc4
;lk_smbpage   $ffc5 - $ffe4
;lk_semmap    $ffe5 - $ffe9
;lk_nmidiscnt $ffea
;lk_taskcnt   $ffeb - $ffe
;lk_modroot   $ffed - $ffee
;lk_consmax   $ffef
;lk_archtype  $fff0
